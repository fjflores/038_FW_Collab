...
root = getrootdir();
subject = "M102";
dataDir = fullfile( root, "Data", subject );
fileName = "2024-08-05_M102_01_kindepth";
% condition = "_good";
% f2check = fullfile( dataDir, fileName )
...
m = memmapfile( fullfile( dataDir, strcat( fileName, ".bin" ) ), ...
      'Format', 'uint16',...
      'Writable', false );
