...
exp172Temps = readtable(...
    fullfile( getrootdir, 'Data', 'FW14', 'exp172_temps.xlsx' ) );
exp100Temps = readtable(...
    fullfile( getrootdir, 'Data', 'FW14', 'exp100_temps.xlsx' ) );
% exp94Temps = readtable(...
% fullfile( getrootdir, 'Data', 'FW14', 'exp94_temps.xlsx' ) );
% Add estimated cage temps to exp 100 (all 20 degrees C)
exp100Temps.cageTemp = 20 * ones( height( exp100Temps ), 1 );
% exp94Temps.cageTemp = 20 * ones( height( exp94Temps ), 1 );
injTimes = [ 13 19; 12 38 ];
expTabs = { exp172Temps; exp100Temps };
% injTimes = [ 13 19; 12 38; 11 35 ];
% expTabs = { exp172Temps; exp100Temps; exp94Temps };
